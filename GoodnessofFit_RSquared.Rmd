...
```
Here is a list of all the sigma values in sigmas. NOtice the numbers are between .5 and 20.  
```{r}
...
When we run "rout", we see R-Squared for each signma.  R-Square tanks going from .98 to .009!  

Here is a list of all the rout output which is R-Squared for each signma.
```{r}
...
All we did was to increase the standard deviation.  Keep in mind, nothing is wrong with this model, all we changed was the spread of x. 

Here is a plot of rout ~ Sigmas 
