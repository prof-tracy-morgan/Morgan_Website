...
author:
  - name: Dr. Joshua O.S.Hunt, Mississippi State University
...
**Assertion:**  By making the variance (sigma squared) larger, we drive R-squared towards 0.  This is not good!  $$σ2$$



This happens even when every assumption of the simple linear regression model is correct.
---
