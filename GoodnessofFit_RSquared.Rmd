...
author:
  - name: Dr. Joshua O.S.Hunt, interpreted by Tracy Morgan  
...
**Assertion:**  By making the variance (sigma squared) $$σ2$$ is large, we drive R-squared towards 0.  This is not good!  

This happens when every assumption of the simple linear regression model is correct in every particular.
